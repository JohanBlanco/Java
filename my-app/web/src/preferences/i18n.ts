...
const messages = {
  es: {
    ...
    'settings.privateAccessDescription': 'Contraseña del dueño para ocultar secciones sensibles (estadísticas y otras que agregues después).',
  ...
  en: {
    ...
    'settings.privateAccessDescription': 'Owner password to hide sensitive sections (statistics and others you add later).',
